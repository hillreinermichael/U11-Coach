const CACHE_NAME="u11-coach-v30.48";
const ASSETS=["./","./index.html","./manifest.webmanifest","./u11-coach-icon-192.png","./u11-coach-icon-512.png","./u11-parcours-aufbau.png","./u11-reaction-chase-game.png"];
